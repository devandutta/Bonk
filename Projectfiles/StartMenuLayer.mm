...
-(id) init
{
    if((self=[super init]))
    {
        ...
        CCLabelTTF *play_label = [CCLabelTTF labelWithString:@"Play" fontName:@"Helvetica" fontSize:80];
        ...
        play.position = ccp(screenSize.width/2, screenSize.height/2+70);
        CCMenu *menu = [CCMenu menuWithItems:play, nil];
        menu.position = ccp(0,0);
        [self addChild:menu];
        
        CCLabelTTF *settingsLabel = [CCLabelTTF labelWithString:@"Settings" fontName:@"Helvetica" fontSize:65];
        settingsLabel.color = ccc3(0,51,255);
        CCMenuItemLabel *settingsButton = [CCMenuItemLabel itemWithLabel:settingsLabel target:self selector:@selector(reactToSettings:)];
        settingsButton.position = ccp(screenSize.width/2, screenSize.height/2-40);
        CCMenu *settingsButtonMenu = [CCMenu menuWithItems:settingsButton, nil];
        settingsButtonMenu.position = ccp(0,0);
        [self addChild:settingsButtonMenu];
        ...
        numberQuestionsDisplayValueLabel.position = ccp(screenSize.width/2, screenSize.height/2 + 10);
        numberQuestionsDisplayValueLabel.visible = NO;
        ...
        maxNumberDisplayValueLabel.position = ccp(screenSize.width/2, screenSize.height/2-45);
        maxNumberDisplayValueLabel.visible = NO;
        ...
        negativeDisplayValueLabel.visible = NO;
...
-(void) reactToSettings: (CCMenuItem *) menuItem
{
    CCTransitionMoveInR *transition = [CCTransitionMoveInR transitionWithDuration:0.7 scene:(CCScene *) [[Settings alloc] init]];
    [[CCDirector sharedDirector] replaceScene:transition];
}
